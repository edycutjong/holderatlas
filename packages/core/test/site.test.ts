...
// (CI/CD run 35403328540, 2026-09-18). Anything that is not a parseable http(s) URL resolves to the canonical domain.
import { describe, it, expect } from "vitest";
import { resolveSite, SITE } from "@/components/Shell";

const D = "https://holderatlas.edycu.dev";
describe("resolveSite", () => {
  ...
  it("keeps a real http(s) origin and drops any path", () => {
    expect(resolveSite("https://holderatlas-edycutjong.vercel.app/judge?x=1", D)).toBe("https://holderatlas-edycutjong.vercel.app");
